...
const NavBar = () => {
  ...
  return <header className="sticky top-0 z-50 w-full bg-white border-b shadow-sm">
      <div className="container flex h-16 items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          {isLoggedIn ? <Button variant="outline" size="sm" onClick={handleLogout} className="flex items-center gap-1" data-testid="logout-button">
              ...
              <Button className="bg-ergi-primary hover:bg-ergi-dark" size="sm" onClick={() => navigate('/register')} data-testid="register-button">
                S'inscrire
              </Button>
            </>}
        </div>
